...
function changeMainButtonsState() {
    if (fullnameInput.value.length === 0 || emailInput.value.length === 0 || dropdownInputOrganization.value.length === 0 || positionInput.value.length === 0 || mobilePhoneInput.value.length === 0 || (!emailInCard.textContent.includes("@") && emailInput.value.length > 0)) {
        generateCardButton.disabled = true;
    }
    else{
        generateCardButton.disabled = false;
    }
    if (fullnameInput.value.length + emailInput.value.length + dropdownInputOrganization.value.length + mobilePhoneInput.value.length + workPhoneInput.value.length === 0 || (!emailInCard.textContent.includes("@") && emailInput.value.length > 0)) {
