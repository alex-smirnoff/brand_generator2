...
function createBusinessCard () {
    ...
    const workPhoneMargin = companyInCard.getBoundingClientRect().height > 14 ? 77.95 : 87.06;
    ...
    let additionalInfoMargin = (positionInCard.getBoundingClientRect().top - cardFront.getBoundingClientRect().top + positionInCard.getBoundingClientRect().height + tempDifference) * 141.73 / 210;
    if (window.innerWidth < 415) {
        additionalInfoMargin = (positionInCard.getBoundingClientRect().top - cardFront.getBoundingClientRect().top + positionInCard.getBoundingClientRect().height + tempDifference + 16) * 141.73 / 210;
        if (fullnameInCard.getBoundingClientRect().height > 27) {
            additionalInfoMargin = (positionInCard.getBoundingClientRect().top - cardFront.getBoundingClientRect().top + positionInCard.getBoundingClientRect().height + tempDifference + 5) * 141.73 / 210;
        }
    }
    if (window.innerWidth < 350) {
        additionalInfoMargin = (positionInCard.getBoundingClientRect().top - cardFront.getBoundingClientRect().top + positionInCard.getBoundingClientRect().height + tempDifference + 22) * 141.73 / 210;
        if (fullnameInCard.getBoundingClientRect().height > 27) {
            additionalInfoMargin = (positionInCard.getBoundingClientRect().top - cardFront.getBoundingClientRect().top + positionInCard.getBoundingClientRect().height + tempDifference + 5) * 141.73 / 210;
        }
    }
